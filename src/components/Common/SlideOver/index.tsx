        ...
        <div className="absolute inset-0 overflow-hidden">
          <section className="absolute inset-y-0 right-0 flex max-w-full">
            ...
            >
              ...
              >
                <div className="hide-scrollbar flex h-full flex-col overflow-auto rounded-lg bg-gray-800 bg-opacity-80 shadow-xl ring-1 ring-gray-700 backdrop-blur">
                  ...
                  <div className="flex-1 px-4 py-6 text-white">{children}</div>
                </div>
              </div>
            </Transition.Child>
          </section>
