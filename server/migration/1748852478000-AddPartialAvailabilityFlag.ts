...
export class AddPartialAvailabilityFlag1748852478000
  implements MigrationInterface
{
  name = 'AddPartialAvailabilityFlag1748852478000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "media_request" ADD COLUMN "partialAvailabilityNotified" boolean NOT NULL DEFAULT (0)`
    );
  }
