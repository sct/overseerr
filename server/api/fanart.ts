...
class FanartAPI extends ExternalAPI {
  ...
  public async getArtistImagesByMbid(
    mbid: string
  ...
  public async getAlbumImagesByMbid(
    mbid: string
  ...
  public pickArtistThumbnail(
    ...
    const sources = preferHd
      ...
      : [
          images.musicartistthumb,
          images.artistthumb,
          images.hdmusicartistthumb,
        ];
  ...
  public pickAlbumCover(images: FanartAlbumImages | null): string | undefined {
